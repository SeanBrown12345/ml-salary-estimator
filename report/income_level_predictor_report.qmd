...
![Confusion matrix of model performance on test data.](../results/figures/confusion_matrix.png){#fig-conf-mat fig-pos="H" width=80%}

![Precision Recall Curve](../results/figures/precision_recall_curve.png){#fig-pre fig-pos="H" width=80%}
...
One possible limitations of our analysis is class imbalance. With far fewer high-income cases, our model can be biased towards the majority class. Another limitation is the generalizabilty of our results. Since our model was trained on data extracted from a 1994 census, it may not accurately reflect patterns in today's population. Additionally, a key limitation is model complexity, our chosen model may not have been capable of capturing all the relationships within the data.
